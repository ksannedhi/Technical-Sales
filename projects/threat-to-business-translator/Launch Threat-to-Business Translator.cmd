...
start "CyberRisk Narrator - Backend" powershell -NoExit -NoProfile -ExecutionPolicy Bypass -Command "cd '%BACKEND%'; .\.venv\Scripts\Activate.ps1; uvicorn app.main:app --reload --no-access-log --log-level warning"
