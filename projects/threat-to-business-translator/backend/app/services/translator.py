...
SCENARIO_MATCHERS = {
    ...
    "finance-sql-server-rce": {
        "keywords": {
            ...
            "sam database": 5,
            "lsass": 5,
            # POS / payment terminal — retail transaction data breach class
            "point of sale": 5,
            "pos terminal": 5,
            "pos system": 5,
            "ingenico": 5,
    ...
    "vpn-zero-day-finance": {
        "keywords": {
            ...
            "internet-facing": 3,
            "scan report": 1,
            # Firewall/edge vendor names — decisive signals for perimeter CVEs
            "pan-os": 5,
            "palo alto": 4,
            "fortinet": 4,
            "fortigate": 5,
            ...
            "f5": 4,
            "big-ip": 5,
            "tmui": 5,    # F5 BIG-IP management UI
            "citrix": 4,
            "netscaler": 5,
            "pulse secure": 5,
            "ivanti": 4,
    ...
    "cloud-workload-rce": {
        "keywords": {
            ...
            "cloud instance": 3,
            "virtual machine": 3,
            # Java/JVM RCE class — Log4Shell and deserialization CVEs
            "log4j": 5,
            "log4shell": 5,
            "jndi": 5,
            "java deserialization": 5,
            "deserialization": 3,
            "jdbc appender": 5,
            "xstream": 5,
            "ognl": 5,      # Struts/expression injection
            "struts": 4,
        },
    },
    ...
    "ot-scada-attack": {
        "keywords": {
            ...
            "process control": 4,
            "factory floor": 3,
            # OT vendor names — decisive signals for manufacturing CVEs
            "rockwell": 5,
            "allen-bradley": 5,
            "micrologix": 5,
            "logix": 4,
            ...
            "panasonic": 4,
            "insecure default": 4,
            "default credential": 4,
            "default permission": 4,
            "buffer overflow": 3,
        },
    },
    ...
    "cicd-pipeline-compromise": {
        "keywords": {
            ...
            "npm package": 3,
            "pypi": 3,
            # Boost Jenkins CVE routing — prevents dict-order tie-loss to api-exposure
            "jenkins cli": 5,
            "build server": 5,
            "arbitrary code execution": 4,
            "groovy script": 5,  # Jenkins script console / pipeline RCE
    ...
    "network-protocol-exposure": {
        "keywords": {
            ...
            "client-side authentication": 5,
            "authentication performed on the client": 5,
            "certificate number": 4,
            "credential storage": 5,
            "stored credential": 5,
            "stored credentials": 5,
            "weak credential": 4,
            "in transit": 3,
        },
    },
